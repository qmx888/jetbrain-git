...
internal class AnotherOneToManyRefEntityData : WorkspaceEntityData<AnotherOneToManyRefEntity>() {
  ...
  override fun getMetadata(): EntityMetadata {
    return MetadataStorageImpl.getMetadataByTypeFqn("com.intellij.platform.workspace.storage.testEntities.entities.cacheVersion.AnotherOneToManyRefEntity") as EntityMetadata
  }
