...
internal class AnotherOneToOneRefEntityData : WorkspaceEntityData<AnotherOneToOneRefEntity>() {
  ...
  override fun getMetadata(): EntityMetadata {
    return MetadataStorageImpl.getMetadataByTypeFqn("com.intellij.platform.workspace.storage.testEntities.entities.currentVersion.AnotherOneToOneRefEntity") as EntityMetadata
  }
