      ...
      get() {
        ...
        return if (_diff != null) {
          ((_diff as MutableEntityStorageInstrumentation).getParentBuilder(PARENTENTITY_CONNECTION_ID,
                                                                           this) as? ParentMultipleEntityBuilder)
          ?: (this.entityLinks[EntityLink(false, PARENTENTITY_CONNECTION_ID)] as? ParentMultipleEntityBuilder)
          ?: error("parentEntity is null for ChildMultipleEntity")
        }
        else {
          (this.entityLinks[EntityLink(false, PARENTENTITY_CONNECTION_ID)] as? ParentMultipleEntityBuilder)
          ?: error("parentEntity is null for ChildMultipleEntity")
...
internal class ChildMultipleEntityData : WorkspaceEntityData<ChildMultipleEntity>() {
  ...
  override fun wrapAsModifiable(diff: MutableEntityStorage): WorkspaceEntityBuilder<ChildMultipleEntity> {
