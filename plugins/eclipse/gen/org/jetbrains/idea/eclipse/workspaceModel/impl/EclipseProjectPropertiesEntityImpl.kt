...
import org.jetbrains.idea.eclipse.config.EclipseProjectPropertiesEntityBuilder
    ...
    override var module: ModuleEntityBuilder
      get() {
        ...
        return if (_diff != null) {
          ...
          ?: error("module is null for EclipseProjectPropertiesEntity")
        }
        else {
          (this.entityLinks[EntityLink(false, MODULE_CONNECTION_ID)] as? ModuleEntityBuilder)
          ?: error("module is null for EclipseProjectPropertiesEntity")
...
internal class EclipseProjectPropertiesEntityData : WorkspaceEntityData<EclipseProjectPropertiesEntity>() {
  ...
  override fun createDetachedEntity(parents: List<WorkspaceEntityBuilder<*>>): WorkspaceEntityBuilder<*> {
    return EclipseProjectPropertiesEntity(variablePaths,
                                          eclipseUrls,
                                          unknownCons,
                                          knownCons,
                                          forceConfigureJdk,
