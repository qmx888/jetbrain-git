...
public class JUnit6SuiteApiIntegrationTest extends AbstractTestFrameworkCompilingIntegrationTest {
  ...
  public void testInitSubSuiteFailed() throws ExecutionException {
    ...
    assertEquals("""
                   ...
                   ##TC[testSuiteFinished id='|[engine:junit-platform-suite|]/|[suite:org.example.failed.SuiteOk|]/|[engine:junit-jupiter|]/|[class:org.example.failed.FailedTest|]' name='FailedTest' nodeId='|[engine:junit-platform-suite|]/|[suite:org.example.failed.SuiteOk|]/|[engine:junit-jupiter|]/|[class:org.example.failed.FailedTest|]' parentNodeId='0' duration='##duration##']""",
                 tests);
  }
}